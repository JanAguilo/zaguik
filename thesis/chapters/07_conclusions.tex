...
\textbf{Stronger commitment binding.} The binding between the public hash and the circuit input could be moved inside the circuit, for instance by verifying a SNARK-friendly hash of the encoded input as part of the statement. This would remove the honest-prover assumption on the commitment, at the cost of additional circuit complexity.
