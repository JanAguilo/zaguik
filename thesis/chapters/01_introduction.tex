...
This thesis presents \emph{Zaguik}, a privacy-preserving attestation system that proves, in zero knowledge, that an LLM output passed a PII filter. The contributions of this work are:
